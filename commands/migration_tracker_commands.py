...
import service.migration_tracke_servicer as migration_tracke_servicer
...
class MigrationTrackerCommands(commands.Cog):
    ...
    async def addchannel_command(self, interaction: discord.Interaction, channel: Optional[discord.TextChannel] = None):
        ...
        try:
            ...
            if success:
                # Rebuild cache
                await migration_tracke_servicer.rebuild_cache_and_restart_if_needed(self.bot)
    ...
    async def status_command(self, interaction: discord.Interaction):
        ...
        try:
            ...
            tracking_status = migration_tracke_servicer.get_tracking_status()
